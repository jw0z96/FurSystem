...
\hline
\end{tabular}
\caption{\label{figure:distributionPerformance} Performance metrics showing time taken to distribute varying numbers of primitives, on meshes of varying triangle counts. The system used had an Intel Core i7-6700 CPU, and an NVIDIA GTX1080 GPU.}
\end{center}
\end{figure}
...
\hline
\end{tabular}
\caption{\label{figure:fullPerformance} Performance metrics showing the time taken to perform a full graph evaluation on a complex setup, as seen in INSERT PIC, for meshes of varying triangle counts.}
\end{center}
\end{figure}
